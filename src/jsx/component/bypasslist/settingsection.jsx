export default function(renderer, app, window, document) {
  ...
  return class extends React.Component {
    render() {
      ...
      const ruleCount = this.getRuleCount(bypasslist.visibleSize());
      return(
        <div>
    ...
    getRuleCount(count) {
      if(count === 0) { return t("NoRulesAdded"); }
      else if(count === 1) { return t("OneRuleAdded"); }
      else { return t("MultipleRulesAdded", {count}); }
    }
  }
}
